page 50022 "BOL Form"
{
        ...
        area(content)
        {
            ...
            group(Shipper)
            {
                ...
                field("Shipper Code"; Rec."Shipper Code")
                {
                    ...
                    ToolTip = 'Specifies the value of the Shipper Code field.';
                    ApplicationArea = All;
                }
    ...
    actions
    {
        area(processing)
        {
            action("Print Bill of Lading")
            {
                Caption = 'Print Bill of Lading';
                Promoted = true;
                PromotedCategory = Process;
                ToolTip = 'Executes the Print Bill of Lading action.';
                ApplicationArea = All;
                trigger OnAction()
                begin
