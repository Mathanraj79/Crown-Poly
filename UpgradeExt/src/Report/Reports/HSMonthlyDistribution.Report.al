report 50032 "HS Monthly Distribution"
{
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            column(HS_Monthly_Distribution_ReportCaption; HS_Monthly_Distribution_ReportCaptionLbl)
            {
            }
            ...
            begin
                ...
                FOR i := 1 TO 12 DO BEGIN
                    ...
                    recSales.SETFILTER("Shortcut Dimension 1 Code", 'HSF');
                    ...
                    recCrMemo.SETFILTER("Shortcut Dimension 1 Code", 'HSF');
            ...
            begin
                IF PrintToExcel THEN BEGIN
                    RowNo += 1;
                    EnterCell(RowNo, 1, 'HS Monthly Distribution Report', TRUE, FALSE, TRUE, '', TempExcelBuffer."Cell Type"::Text);
            ...
            area(content)
            {
                group(Options)
                {
                    ...
                    field("Case Display"; CaseDisplay)
                    {
                        ...
                        caption = 'CaseDisplay';
                        ApplicationArea = all;
                        OptionCaption = 'Actual Case ,1000 Per Case';
                    }
                }
            }
        }
    ...
    begin
        IF PrintToExcel THEN BEGIN
            //  TempExcelBuffer.CreateBook('HS Monthly Distribution');
            //  TempExcelBuffer.UpdateBook('HS Monthly Distribution','HS Monthly Distribution');

            //TempExcelBuffer.GiveUserControl;
            TempExcelBuffer.CreateNewBook('HS Monthly Distribution');
            TempExcelBuffer.WriteSheet('HS Monthly Distribution', CompanyName, UserId);
    ...
    var
        ...
        HS_Monthly_Distribution_ReportCaptionLbl: Label 'HS Monthly Distribution Report';
