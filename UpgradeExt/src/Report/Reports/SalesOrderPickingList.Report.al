report 50048 "Sales Order Picking List"
{
    // SCS1.1 Add Logo
    // //IWEB406 - Pallet Calculation corrected
    DefaultLayout = RDLC;
    RDLCLayout = 'src\Report\Layout\SalesOrderPickingList.rdl';
    ApplicationArea = all;
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            RequestFilterFields = "No.", "Sell-to Customer No.", "Bill-to Customer No.", "Ship-to Code", "Pick List Printed";
            ...
            column(PICKED_QUANTITYCaption; PICKED_QUANTITYCaptionLbl)
            {
            }
            column(V5700_Bickett_St____Huntington_Park__CA__90255_; '5700 Bickett St.,  Huntington Park, CA  90255')
            {
            }
            column(Sales_Header__Notes; "Sales Header".Notes)
            {
            }
            ...
            column(Sales_Header___No__Printed_; "Sales Header"."No. Printed")
            {
            }
            column(Sales_Header___No______; '*' + "Sales Header"."No." + '*')
            {
            }
            ...
            column(No__Printed_Caption; No__Printed_CaptionLbl)
            {
            }
                    ...
                    dataitem(SalesLine; Integer)
                    {
                        ...
                        begin
                            ...
                            IF TempSalesLine.Type = TempSalesLine.Type::Item THEN begin
                                ...
                                IF ItemRec.GET(TempSalesLine."No.") THEN
                                    IF ItemRec."Case Count" <> 0 THEN
                                        //IWEB406 - START
                                        //TotalPallets +=  Quantity / TempItem."Case Count";
                                        TotalPallets += (TempSalesLine.Quantity - TempSalesLine."Quantity Shipped") / ItemRec."Case Count";
                                //IWEB406 - END
                            END;
                            ...
                            IF TempSalesLine."Quantity Shipped" <> 0 THEN
                                QtyBackOrdered := TempSalesLine.Quantity - TempSalesLine."Quantity Shipped";
    ...
    var
        ...
        FOB: Record FOB;
        ItemRec: Record Item;
        SalesPrinted: Codeunit "Pick List-Printed";
